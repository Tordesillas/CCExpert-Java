...
public class AetherockProcessor {
    ...
    public AetherockProcessor(Resources res) {
        this.res = res;
    }
    ...
    public String printAetherockAmount(int firstLevel, int secondLevel) {
        ...
        return res.getString(R.string.processorText8) + f.format(amount) + "\n" +
                res.getString(R.string.processorText9) + f.format(DAMAGES_BY_LEVEL[secondLevel]-DAMAGES_BY_LEVEL[firstLevel]) + "\n" +
                res.getString(R.string.processorText10) + f.format(HEALTH_POINTS_BY_LEVEL[secondLevel]-HEALTH_POINTS_BY_LEVEL[firstLevel]);
    }
}
