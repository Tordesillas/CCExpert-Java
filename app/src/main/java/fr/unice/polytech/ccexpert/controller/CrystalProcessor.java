...
public class CrystalProcessor {/*
    ...
    public Container printCrystalAmount(int firstLevel, int secondLevel) {
        int attack = 0;
        int life = 0;
        int power = 0;
        int crystals = 0;
        ...
        c.addComponent(new Label("Cristaux à dépenser : " + l10n.format(crystals)));
        c.addComponent(new Label("Mana à dépenser : " + l10n.format(mana)));
        c.addComponent(new Label("Vie gagnée : " + l10n.format(life)));
        c.addComponent(new Label("Attaque gagnée : " + l10n.format(attack)));
        c.addComponent(new Label("Puissance gagnée : " + l10n.format(power)));
