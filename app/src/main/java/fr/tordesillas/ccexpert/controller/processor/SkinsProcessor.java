...
public class SkinsProcessor {
    private static final int[] HP_BY_LEVEL = {10000, 2625, 0, 0, 3250, 0, 0, 4125, 0, 0, 5250, 0, 0, 6625, 0, 0, 8250, 0, 0, 10125};
    private static final int[] ATK_BY_LEVEL = {0, 105, 0, 0, 130, 0, 0, 165, 0, 0, 210, 0, 0, 265, 0, 0, 330, 0, 0, 405};
    private static final int[] TENA_BY_LEVEL = {0, 0, 15, 0, 0, 25, 0, 0, 35, 0, 0, 45, 0, 0, 55, 0, 0, 55, 0, 0};
    private static final int[] DODGE_BY_LEVEL = {0, 0, 0, 75, 0, 0, 105, 0, 0, 135, 0, 0, 165, 0, 0, 195, 0, 0, 195, 0};
    private static final int[] SHARD_BY_LEVEL = {0, 560, 840, 1120, 1400, 1680, 1960, 2240, 2520, 2800, 3080, 3360, 3640, 3920, 4200, 4480, 4760, 5040, 5320, 5600};
